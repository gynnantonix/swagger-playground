...
import (
	...
	"github.com/gynnantonix/swagger-playground/models"
	"github.com/gynnantonix/swagger-playground/restapi/operations"
	"github.com/gynnantonix/swagger-playground/restapi/operations/todos"
)
...
func addItem(item *models.Item) error {
	if item == nil {
		return errors.New(500, "missing item")
	}
...
//go:generate swagger generate server --target ../../swagger-playground --name TodoList --spec ../swagger.yml --principal interface{}
